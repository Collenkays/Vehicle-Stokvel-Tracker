...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('Vikoba', options)
  );
});
...
// Helper function for syncing offline contributions
async function syncContributions() {
  try {
    // Get offline contributions from IndexedDB or cache
    // This would integrate with your Supabase sync logic
    console.log('Syncing offline contributions...');
